<h1 class="display-4">Открытые заявки</h1>
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link" href="/requests/all">Все заявки </a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" href="/requests/open">Открытые <span class="badge badge-secondary"><?=$requests_count?></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="/requests/inwork">В работе</span></a>
    </li>
    <li class="nav-item">

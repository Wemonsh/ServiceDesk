<h1 class="display-4">Замороженные заявки</h1>
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link active" href="/requests/frozen">Замороженные <span class="badge badge-secondary"><?=$requests_count?></span></a>
    </li>
</ul>

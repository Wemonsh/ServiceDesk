...
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link" href="/requests/my_in_work">В работе</a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" href="/requests/my_frozen">Замороженные <span class="badge badge-secondary"><?=$requests_count?></span></a>
    </li>
    <li class="nav-item">
...
<table class="table table-bordered table-sm mt-3">
    ...
    <?php foreach ($requests as $value): ?>
        <tr>
            ...
            <td class="align-middle text-center" style="width: 50px">
                    <p><a href="/requests/defrosting/<?=$value['id']?>"><i data-toggle="tooltip" data-placement="top" title="Вернуть в работу" style="font-size: 30px" class="fas fa-play-circle text-warning"></i></a></p>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
